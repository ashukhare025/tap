...
Widget liveCrowdCard(HomeController controller) {
  return Obx(
    () => Container(
      height: 430,
      ...
      child: Column(
        ...
        children: [
          ...
          /// Bottom Info
          Row(children: [Text("🔥 High activity right now", style: InterRegu)]),
          SizedBox(height: 6),
          Row(
            children: [
              Text("🟢 Best time to visit: ", style: InterRegu),
              Text("9–11PM", style: InterSemiBol),
            ],
          ),
          SizedBox(height: 6),
          Row(children: [Text("👥 Crowd level: Medium", style: InterRegu)]),
          ...
          Center(
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text("View More Stats", style: PopMediu),
              ),
            ),
          ),
        ],
